...
def predict():
    ...
    if output == 0:
        ...
        predict = "Low Vegetation"
    elif output == 4:
        predict = "Medium Vegetation"
    elif output == 5:
        predict = "High Vegetation"
    elif output == 6:
        predict = "Ground"
    elif output == 7:
        predict = "Building"
    ...
    return render_template('results.html', prediction_text=" Lidar point cloud class :  {}  ".format(predict))
